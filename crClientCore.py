...
def cyclicFunc():
    #Check if this module being first time run in the server.
    ...
    if clientName not in templis:
        connectionVar.execute("INSERT INTO constellationClientTable (clientName, clientBlocked, clientStatus) VALUES "\
            "('"+clientName+"','ACTIVE','STANDBY')")
