    ...
    def __init__(self):
        ...
        while True:
            ...
            if commandVar == 'exit':
                ...
                self.printHelp()
            elif commandVar == 'setup': self.setupFun()
            elif commandVar == 'addRdrr': self.addRdrrFun()
            elif commandVar == 'listRdrr': self.listRdrrFun()
            elif commandVar == 'delRdrr': self.deleteRdrrFun()
